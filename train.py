...
from model_cfwgan2 import CFWGAN
...
model = CFWGAN(train, dataset.item_count, alpha=0.1, s_zr=0.5, s_pm=0.5, d_steps=3, g_steps=5)
model.train(DataLoader(train, batch_size, shuffle=True), DataLoader(val, batch_size*2))
